    ...
    return (
        ...
        <section id="hero" class=" ">
         ...
         <Fade left duration={2000}>
           ...
           <div className="w-full px-4  md:px-0  mx-auto flex items-center min-h-screen bg-red-50   flex-wrap bg-none md:bg-hero bg-contain   bg-right-bottom hero bg-no-repeat"> 
           ...
           <Slide left cascade duration={2000}>
            ...
            Hi, I'm Zara. 
              ...
              A design-minded Developer <br></br>focused on building beautiful<br></br> interfaces & experiences.
            ...
            {  <Fade right duration={2000}><div className="w-full md:hidden">
              <img
                className="w-full"
                alt="hero"
