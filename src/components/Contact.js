...
export default function Contact() {
  ...
  return (
    <section id="contact"  >
      ...
      <Slide left  duration={2000}>       <h1 className="md:text-6xl text-4xl font-medium text-center text-gray-700 title-font  md:mb-24 mb-12  ">
        Get In Touch
      </h1></Slide>
      <Fade duration={500}>  
    ...
    <label>Don’t fill this out if you’re human: <input name="bot-field" /></label>
            ...
            <p className="leading-relaxed text-gray-700 mb-5">
              Whether you have a question or want to
              hire me, My inbox is always open.  
        ...
        <Fade left cascade duration={2000}>    <div className="w-auto mx-auto">
           ...
           <a href="https://www.linkedin.com/in/thezarakhan/" target="_blank" rel="noopener noreferrer" >
             <svg className="svg mx-auto my-2" xmlns="http://www.w3.org/2000/svg" width="26"  height="26" viewBox="0 0 24 24" >
             <path d="m23.994 24v-.001h.006v-8.802c0-4.306-.927-7.623-5.961-7.623-2.42 0-4.044 1.328-4.707 2.587h-.07v-2.185h-4.773v16.023h4.97v-7.934c0-2.089.396-4.109 2.983-4.109 2.549 0 2.587 2.384 2.587 4.243v7.801z"/><path d="m.396 7.977h4.976v16.023h-4.976z"/><path d="m2.882 0c-1.591 0-2.882 1.291-2.882 2.882s1.291 2.909 2.882 2.909 2.882-1.318 2.882-2.909c-.001-1.591-1.292-2.882-2.882-2.882z"/>
            </svg>
            </a> 
            <a href="https://github.com/TheZaraKhan" target="_blank" rel="noopener noreferrer" >
            <svg className="svg mx-auto my-2" xmlns="http://www.w3.org/2000/svg" width="26"  height="26" viewBox="0 0 24 24" >
            ...
            <a href="https://www.instagram.com/zara_mustafa/" target="_blank" rel="noopener noreferrer" >
            <svg className="svg mx-auto my-2" xmlns="http://www.w3.org/2000/svg" width="26"  height="26" viewBox="0 0 24 24" >
            ...
            <a href="https://codepen.io/Zaraa" target="_blank" rel="noopener noreferrer" >
            <svg className="svg mx-auto my-2" xmlns="http://www.w3.org/2000/svg" width="26"  height="26" viewBox="0 0 24 24" >
            ...
            <svg className=" fill-red-100  transition ease-in-out duration-500   mx-auto inline-block my-2" xmlns="http://www.w3.org/2000/svg" width="26"  height="26" viewBox="0 0 24 24" >
            ...
            <a class="hover:underline transition ease-in-out duration-500   pl-2 inline-block cursor-pointer" href="mailto:ZaraTariqKhan@gmail.com">Zaratariqkhan@gmail.com</a></p>
