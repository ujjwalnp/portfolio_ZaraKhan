  ...
  return (
    ...
    <Slide left  duration={2000}>   <h1 className="md:text-6xl  text-gray-700 text-4xl font-medium text-center title-font   ">
      ...
      <div className="  hidden sm:flex relative lg:w-3/4 w-full  items-center mx-auto mt-32">
         <Slide left cascade duration={1000}> <div className="absolute  w-3/6  left-0 z-20 ">
       <div>   <a
          ...
          {projects.tags.map(x => <span className="text-gray-600 pr-4" key={x.tag}>{x.tag}</span>)}  
          </p>
        </div></Slide>

        <Zoom   duration={2000}>
          <div>
        <a  href={projects.link} target="_blank" rel="noopener noreferrer" ><div className="z-10   img-gradient   ">
...
{projects.map((projects) => (  
     <Slide left cascade duration={1000}>   <div className="sm:hidden mt-16 block w-full">
